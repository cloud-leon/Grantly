...
void main() {
  group('FinancialAidScreen', () {
    Future<void> pumpTestWidget(WidgetTester tester) async {
      await tester.pumpWidget(
        const TestWrapper(
          child: FinancialAidScreen(),
        ),
      );
    }
    ...
    testWidgets('renders correctly', (WidgetTester tester) async {
      ...
      expect(
        find.text('Are you eligible for\nfinancial aid?'),
        findsOneWidget,
      );
      expect(
        find.text('We will use this to find need-based scholarships.'),
        findsOneWidget,
      );
    ...
    testWidgets('navigates to MilitaryScreen on next', (WidgetTester tester) async {
      await pumpTestWidget(tester);
    ...
    testWidgets('navigates to FirstGenScreen on back', (WidgetTester tester) async {
      await pumpTestWidget(tester);
